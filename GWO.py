...
class GWO:
    ...
    def run(self):
        ...
        while count < self.max_iter:
            for i in range(self.wolf_num):# for each worlf
                ...
                fitness = self.func(self.position[i,:]) # calculate the fitness of each worlf
            ...
            for i in range(self.wolf_num):# update each worf position
                for j in range(self.dim):# update every dimension's position of the worf i 
